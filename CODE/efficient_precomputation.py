...
wordfile = './CustomWordleAlgs-main/allowed_words.txt'
savefile = './CustomWordleAlgs-main/datafile.npy'
solutionfile = './CustomWordleAlgs-main/solutions.txt'

# Load allowed words into a numpy array
#words1=np.readtxt(wordfile, dtype='str')
